...
import { visibleTaskLimit as filteredTasksLimit } from '@/lib/data'
...
const HomePage = () => {
    ...
    const fetchTasks = async () => {
        try {
            const res = await api.get(`/tasks?filter=${dateQuery}&pageNumber=${pageNumber}`)
                ...
                <div className='container pt-8 mx-auto relative z-10'>
                    <div className='w-full max-w-2xl p-6 mx-auto space-y-6'>
                        ...
                        <div className='flex flex-col items-center justify-between gap-6 sm:flex-row'>
                            <TaskListPagination page={pageNumber} totalPages={totalPages} handleNext={handleNext} handlePrev={handlePrev} handlePageChanged={handlePageChanged} />
